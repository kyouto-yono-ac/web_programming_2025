...
| 13  | 最終課題演習（1）                     | 最終課題説明、テーマ選定・設計、アプリ制作開始。補足: `st.set_page_config`, `st.tabs`, `st.container`, `st.subheader`, メッセージ表示 (`st.info`等) | 各自でのアプリ開発、質疑応答           |
| 14  | 最終課題演習（2）とデプロイ            | 最終課題制作の続き、完成、GitHubへのアップロード、Streamlit Community Cloudへのデプロイ                                                | 各自でのアプリ開発、技術サポート       |
| 15  | 最終課題発表会と相互評価              | 作成したアプリの発表、相互評価、フィードバック、コース全体の振り返り                                        | 発表・評価・まとめ                     |
